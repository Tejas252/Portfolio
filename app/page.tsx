            ...
            <AnimatePresence mode="popLayout">
              { hoveredIndex === 1 && (
                <motion.div
                  ...
                  className="absolute -top-35 left-1/2 z-50 flex -translate-x-1/2 flex-col items-center justify-center rounded-full bg-transparent border-dashed border-2 border-primary px-4 py-2 text-xs shadow-xl"
                >
